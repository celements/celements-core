...
@Component("XObjectPageType")
public class XObjectPageTypeEventConverter extends AbstractXWikiEventConverter {

  private static Log LOGGER = LogFactory.getFactory().getInstance(
      XObjectPageTypeEventConverter.class);
  ...
  private Set<Class<? extends Event>> events = new HashSet<Class<? extends Event>>() {
    ...
    {
      add(XObjectPageTypeDeletedEvent.class);
      add(XObjectPageTypeCreatedEvent.class);
      add(XObjectPageTypeUpdatedEvent.class);
    }
  };
