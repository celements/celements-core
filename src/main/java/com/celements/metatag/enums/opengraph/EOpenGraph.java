...
public enum EOpenGraph implements ValueGetter<String> {
  ...
  OPENGRAPH_TITLE("og:title"), OPENGRAPH_TYPE("og:type"), OPENGRAPH_IMAGE(
      "og:image"), OPENGRAPH_URL(
          "og:url"), OPENGRAPH_OPTIONAL_AUDIO("og:audio"), OPENGRAPH_OPTIONAL_DESCRIPTION(
              "og:description"), OPENGRAPH_OPTIONAL_DETERMINER(
                  "og:determiner"), OPENGRAPH_OPTIONAL_LOCALE(
                      "og:locale "), OPENGRAPH_OPTIONAL_LOCALE_ALTERNATE(
                          "og:locale:alternate"), OPENGRAPH_OPTIONAL_SITENAME(
                              "og:site_name"), OPENGRAPH_OPTIONAL_VIDEO(
                                  "og:video"), OPENGRAPH_OPTIONAL_IMAGE_WIDTH(
                                      "og:image:width"), OPENGRAPH_OPTIONAL_IMAGE_HEIGHT(
                                          "og:image:height");
