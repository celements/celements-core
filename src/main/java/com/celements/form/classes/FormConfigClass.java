...
public class FormConfigClass extends AbstractClassDefinition implements FormClass {
  ...
  public static final ClassField<String> FIELD_FORM_LAYOUT = new StringField.Builder(CLASS_DEF_HINT,
  ...
  public static final ClassField<String> FIELD_SUCCESSFULPAGE = new StringField.Builder(
      CLASS_DEF_HINT, "successfulpage").size(30).build();

  public static final ClassField<String> FIELD_FAILEDPAGE = new StringField.Builder(CLASS_DEF_HINT,
      "failedpage").size(30).build();

  public static final ClassField<String> FIELD_EXCLUDE_FORM_IS_FILLED = new StringField.Builder(
      CLASS_DEF_HINT, "excludeFromIsFilledCheck").size(30).prettyName("Exclude fields from"
          + " 'isFilled' check. (separator: ',')").build();
