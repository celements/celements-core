...
public class FormConfigClass extends AbstractClassDefinition implements FormClass {
  ...
  public static final ClassField<String> FIELD_FORM_LAYOUT = new StringField.Builder(CLASS_REF,
      "formLayout").size(30).prettyName("Formular Layout Name").build();

  public static final ClassField<String> FIELD_SUCCESSFULPAGE = new StringField.Builder(CLASS_REF,
      "successfulpage").size(30).build();

  public static final ClassField<String> FIELD_FAILEDPAGE = new StringField.Builder(CLASS_REF,
      "failedpage").size(30).build();
  ...
  public static final ClassField<String> FIELD_EXCLUDE_FORM_IS_FILLED = new StringField.Builder(
      ...
      .prettyName("Exclude fields from 'isFilled' check. (separator: ',')").build();
