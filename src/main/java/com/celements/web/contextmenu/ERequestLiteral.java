...
public enum ERequestLiteral implements IGenericLiteral {
  ...
  ELEM_IDS_ARRAY(ECommand.ARRAY_COMMAND,
      ELEMENT_ID),
  ELEM_ID_KEY(ECommand.PROPERTY_COMMAND, ELEM_IDS_ARRAY),
  CSS_CLASS_NAME_VALUE(
      ECommand.VALUE_COMMAND),
  CSS_CLASS_NAME(ECommand.PROPERTY_COMMAND,
      CSS_CLASS_NAME_VALUE),
  CSS_CLASS(ECommand.DICTIONARY_COMMAND, CSS_CLASS_NAME,
      ELEM_ID_KEY),
