...
public class WebUtils implements IWebUtils {
  ...
  public List<String> getDocumentParentsList(String fullName, boolean includeDoc,
    ...
    try {
      ...
      while (!"".equals(nextParent) && (context.getWiki().exists(nextParent, context))
  ...
  @Deprecated
  private String getParentFullName(String fullName, XWikiContext context) throws XWikiException {
    return context.getWiki().getDocument(fullName, context).getParent();
  }
  ...
  public List<com.xpn.xwiki.api.Object> getMenuItemsForHierarchyLevel(int menuLevel,
    ...
    if (parent != null) {
      List<com.xpn.xwiki.api.Object> submenuItems = getSubMenuItemsForParent(parent, "", menuPart,
          context);
  ...
  public BaseObject getPrevMenuItem(String fullName, XWikiContext context) throws XWikiException {
    ...
    if (prevTreeNode != null) {
      ...
      return context.getWiki().getDocument(docRef, context).getXObject(getRef(
          "Celements2.MenuItem"));
    }
    return null;
  }
  ...
  public BaseObject getNextMenuItem(String fullName, XWikiContext context) throws XWikiException {
    ...
    if (nextTreeNode != null) {
      ...
      return context.getWiki().getDocument(docRef, context).getXObject(
          new NavigationClasses().getMenuItemClassRef(context.getDatabase()));
    }
    return null;
  }
  ...
  public XWikiDocument getConfigDocByInheritance(XWikiDocument doc, String className,
    ...
    XWikiDocument preferenceDoc = context.getWiki().getDocument(doc.getSpace() + ".WebPreferences",
        context);
    if (preferenceDoc.getObject(className, false, context) == null) {
      ...
      if (preferenceDoc.getObject(className, false, context) == null) {
        ...
        if ((skinDocName != null) && (context.getWiki().exists(skinDocName, context))) {
   ...
   */
  @Deprecated
  public String getDocSection(String regex, String fullName, int section, XWikiContext context)
  ...
  public List<Attachment> getAttachmentListSorted(Document doc, String comparator,
    ...
    return this.getWebUtilsService().getAttachmentListSorted(doc, comparator, imagesOnly, start,
        nb);
  }
  ...
  public List<Attachment> getRandomImages(String fullName, int num, XWikiContext context) {
    try {
      Document imgDoc = context.getWiki().getDocument(fullName, context).newDocument(context);
