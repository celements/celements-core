...
public interface IOldCoreClassConfig {
  ...
  String PHOTO_ALBUM_CLASS = PHOTO_ALBUM_CLASS_SPACE + "." + PHOTO_ALBUM_CLASS_DOC;
  ...
  String XWIKI_USERS_CLASS = XWIKI_USERS_CLASS_SPACE + "." + XWIKI_USERS_CLASS_DOC;
  ...
  String FILEBASE_TAG_CLASS = FILEBASE_TAG_CLASS_SPACE + "." + FILEBASE_TAG_CLASS_DOC;

  String RTE_CONFIG_TYPE_CLASS_DOC = "RTEConfigTypeClass";
  String RTE_CONFIG_TYPE_CLASS_SPACE = "Classes";
  String RTE_CONFIG_TYPE_CLASS = RTE_CONFIG_TYPE_CLASS_SPACE + "." + RTE_CONFIG_TYPE_CLASS_DOC;
  ...
  String OVERLAY_CONFIG_CLASS = OVERLAY_CONFIG_CLASS_SPACE + "." + OVERLAY_CONFIG_CLASS_DOC;

  String PANEL_CONFIG_CLASS_DOC = "PanelConfigClass";
  String PANEL_CONFIG_CLASS_SPACE = "Class";
  String PANEL_CONFIG_CLASS = PANEL_CONFIG_CLASS_SPACE + "." + PANEL_CONFIG_CLASS_DOC;
  ...
  String FORM_ACTION_CLASS = FORM_ACTION_CLASS_SPACE + "." + FORM_ACTION_CLASS_DOC;
   ...
   */
  String FORM_CONFIG_CLASS = FORM_CONFIG_CLASS_SPACE + "." + FORM_CONFIG_CLASS_DOC;

  String ACTION_TYPE_CLASS_DOC = "ActionTypeClass";
  String ACTION_TYPE_CLASS_SPACE = "Celements2";
  String ACTION_TYPE_CLASS = ACTION_TYPE_CLASS_SPACE + "." + ACTION_TYPE_CLASS_DOC;

  String ACTION_TYPE_PROP_CLASS_DOC = "ActionTypeProperties";
  String ACTION_TYPE_PROP_CLASS_SPACE = "Celements2";
  String ACTION_TYPE_PROP_CLASS = ACTION_TYPE_PROP_CLASS_SPACE + "." + ACTION_TYPE_PROP_CLASS_DOC;
