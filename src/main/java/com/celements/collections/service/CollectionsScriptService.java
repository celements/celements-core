...
public class CollectionsScriptService implements ScriptService {
  ...
  public List<com.xpn.xwiki.api.Object> getObjectsOrdered(Document doc, DocumentReference classRef,
      String orderField, boolean asc) {
    return getObjectsOrdered(doc.getDocumentReference(), classRef, orderField, asc, null, false);
  }

  public List<com.xpn.xwiki.api.Object> getObjectsOrdered(Document doc, DocumentReference classRef,
      String orderField1, boolean asc1, String orderField2, boolean asc2) {
    return getObjectsOrdered(doc.getDocumentReference(), classRef, orderField1, asc1, orderField2,
        asc2);
  }
