...
@Remote
public class NavigationDeletedEvent extends AbstractDocumentEvent {
   ...
   */
  public NavigationDeletedEvent(DocumentReference documentReference) {
   ...
   */
  public NavigationDeletedEvent(EventFilter eventFilter) {
    super(eventFilter);
  }
}
