...
@Remote
public class NavigationUpdatedEvent extends AbstractDocumentEvent {
   ...
   */
  public NavigationUpdatedEvent(DocumentReference documentReference) {
   ...
   */
  public NavigationUpdatedEvent(EventFilter eventFilter) {
    super(eventFilter);
  }
}
