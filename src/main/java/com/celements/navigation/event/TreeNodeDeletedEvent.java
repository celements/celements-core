...
@Remote
public class TreeNodeDeletedEvent extends AbstractDocumentEvent {
   ...
   */
  public TreeNodeDeletedEvent(DocumentReference documentReference) {
   ...
   */
  public TreeNodeDeletedEvent(EventFilter eventFilter) {
    super(eventFilter);
  }
}
