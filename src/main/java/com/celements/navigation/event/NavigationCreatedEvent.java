...
@Remote
public class NavigationCreatedEvent extends AbstractDocumentEvent {
   ...
   */
  public NavigationCreatedEvent(DocumentReference documentReference) {
   ...
   */
  public NavigationCreatedEvent(EventFilter eventFilter) {
    super(eventFilter);
  }
}
