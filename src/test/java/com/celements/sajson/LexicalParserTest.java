...
public class LexicalParserTest {
  ...
  private enum ERulesLiteral implements IGenericLiteral {
    ...
    CONDITION_OR_ACTION_DICT(
        ECommand.DICTIONARY_COMMAND, CON_OR_ACT_ATTRIBUTE),
    CONDITIONS_OR_ACTIONS_ARRAY(
        ECommand.ARRAY_COMMAND, CONDITION_OR_ACTION_DICT),
    CONDITION_OR_ACTION_PROPERTY(
        CONDITIONS_OR_ACTIONS_ARRAY, "conditions",
        "actions"),
