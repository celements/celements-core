 ...
 */
@Deprecated
public class PageDepCellConfigClassTest extends AbstractComponentTest {

  private ClassDefinition pageDepCellConfigClass;
  ...
  public void prepareTest() throws Exception {
    ...
    pageDepCellConfigClass = Utils.getComponent(ClassDefinition.class,
        PageDepCellConfigClass.CLASS_DEF_HINT);
  ...
  public void testGetName() {
    String expectedStr = "Celements.PageDepCellConfigClass";
    assertEquals(expectedStr, pageDepCellConfigClass.getName());
  }

  @Test
  public void testGetClassReference() {
    ClassReference expectedClassRef = new ClassReference("Celements", "PageDepCellConfigClass");
    assertEquals(expectedClassRef, pageDepCellConfigClass.getClassReference());
  }

  @Test
  public void test_isInternalMapping() {
    assertFalse(pageDepCellConfigClass.isInternalMapping());
  }

  @Test
  public void test_fields() throws Exception {
    DocumentReference pageTypeClassRef = pageDepCellConfigClass.getClassRef();
