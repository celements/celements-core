 ...
 */
@Deprecated
public class GroupCellClassTest extends AbstractComponentTest {

  private ClassDefinition groupCellClass;
  ...
  public void prepareTest() throws Exception {
    ...
    groupCellClass = Utils.getComponent(ClassDefinition.class, GroupCellClass.CLASS_DEF_HINT);
  ...
  public void testGetName() {
    String expectedStr = "Celements.GroupCellClass";
    assertEquals(expectedStr, groupCellClass.getName());
  }

  @Test
  public void testGetClassReference() {
    ClassReference expectedClassRef = new ClassReference("Celements", "GroupCellClass");
    assertEquals(expectedClassRef, groupCellClass.getClassReference());
  }

  @Test
  public void test_isInternalMapping() {
    assertFalse(groupCellClass.isInternalMapping());
  }

  @Test
  public void test_fields() throws Exception {
    DocumentReference pageTypeClassRef = groupCellClass.getClassRef();
