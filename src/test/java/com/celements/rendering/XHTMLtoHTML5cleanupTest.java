...
public class XHTMLtoHTML5cleanupTest {
  ...
  public void testRemoveSelfclosingTags_null() {
    assertNull(XHTMLtoHTML5cleanup.removeSelfclosingTags(null));
  }

  @Test
  public void testRemoveSelfclosingTags_empty() {
    assertEquals("", XHTMLtoHTML5cleanup.removeSelfclosingTags(""));
  }
  ...
  public void testRemoveSelfclosingTags_nothingToClean() {
    ...
    assertEquals(xhtml, XHTMLtoHTML5cleanup.removeSelfclosingTags(xhtml));
  }
  ...
  public void testRemoveSelfclosingTags_br_hr() {
    ...
    String html5 = "<p>Hi</p><br ><hr><select name=\"abc\"><option value=\"1\">1</option>" +
        "<option value=\"2\">2</option></select>";
    assertEquals(html5, XHTMLtoHTML5cleanup.removeSelfclosingTags(xhtml));
  }
